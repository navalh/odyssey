...
; expect (lambda (x y z) (list x y z))

(lambda (x) (print 5) (/ x 1))
; expect (lambda (x) (begin (print 5) (/ x 1)))
...
(define (f x y) (define (g z w) (display z) (list w x y z)) (g 5 10))
; expect f
f
; expect (lambda (x y) (begin (define (g z w) (display z) (list w x y z)) (g 5 10)))

(f 1 2)
; expect 5(10 1 2 5)

(g 5 10) ;; g should not refer to the most recent g made, but the g whose body is (* x y)
; expect 0.5
...
(define (f x) 
  (if (even? 5) (display 5) (display 6)) 
  (define (g y) (display(* 5 (- 4 3))))
  (define (h z) (list x 'z))
  (g 5)
  (h 10))
; expect f

(f 100) ;;;Should print 6, then 5, then (100 z)
; expect 65(100 z)
...
(cond ((= x y) (display 0) 0)
      ((= x (+ y 1)) (display 1) 1)
      ((and (= y (+ x 2)) (or 1 #f (/ 1 0))) (display 2) 999)
      (else (display 10) 'why))
; expect 2999
...
(define b (mu (u v w) (+ (a) x y z u v w)))
; expect b
